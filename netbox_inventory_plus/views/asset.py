...
class AssetBulkCreateView(generic.BulkCreateView):
    ...
    pattern_target = None
    template_name = "netbox_inventory_plus/asset_bulk_add.html"
...
class AssetEditView(generic.ObjectEditView):
    ...
    template_name = "netbox_inventory_plus/asset_edit.html"
...
class AssetDeleteView(generic.ObjectDeleteView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        logger = logging.getLogger("netbox.netbox_inventory_plus.views.AssetDeleteView")
...
class AssetBulkImportView(generic.BulkImportView):
    ...
    template_name = "netbox_inventory_plus/asset_bulk_import.html"
...
class AssetBulkScanView(generic.BulkEditView):
    ...
    template_name = "netbox_inventory_plus/asset_bulk_scan.html"
