...
class InventoryItemGroupTable(NetBoxTable):
    ...
    asset_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_inventory_plus:asset_list",
        url_params={"inventoryitem_group_id": "pk"},
        verbose_name="Assets",
    )
    inventoryitem_type_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_inventory_plus:inventoryitemtype_list",
        url_params={"inventoryitem_group_id": "pk"},
...
class AssetTable(NetBoxTable):
    ...
    actions = columns.ActionsColumn(
        extra_buttons="""
            ...
            {% else %}
            <a href="{% url 'plugins:netbox_inventory_plus:asset_'|add:record.kind|add:'_create' %}?asset_id={{ record.pk }}" class="btn btn-sm btn-green" title="Create hardware from asset">
                <i class="mdi mdi-vector-difference-ba"></i>
            </a>
            {% endif %}
            <a href="{% url 'plugins:netbox_inventory_plus:asset_assign' record.pk %}" class="btn btn-sm btn-orange" title="Edit hardware assignment">
...
class SupplierTable(ContactsColumnMixin, NetBoxTable):
    ...
    purchase_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_inventory_plus:purchase_list",
        url_params={"supplier_id": "pk"},
        verbose_name="Purchases",
    )
    delivery_count = columns.LinkedCountColumn(
        viewname="plugins:netbox_inventory_plus:delivery_list",
        url_params={"supplier_id": "pk"},
...
class CourierTable(ContactsColumnMixin, NetBoxTable):
    ...
    transfer_count = columns.LinkedCountColumn(
        viewname='plugins:netbox_inventory_plus:transfer_list',
