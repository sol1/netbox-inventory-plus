...
class Migration(migrations.Migration):
    dependencies = [
        ('netbox_inventory_plus', '0003_add_inventoryitemgroup'),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=('parent', 'name'),
                name='netbox_inventory_plus_inventoryitemgroup_parent_name',
            ),
        ),
        migrations.AddConstraint(
            model_name='inventoryitemgroup',
            constraint=models.UniqueConstraint(
                ...
                fields=('name',),
                name='netbox_inventory_plus_inventoryitemgroup_name',
