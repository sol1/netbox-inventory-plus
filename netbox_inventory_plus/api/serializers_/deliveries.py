...
from netbox_inventory_plus.models import BOM, Delivery, Purchase, Supplier
...
class SupplierSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_inventory_plus-api:supplier-detail"
    )
...
class BOMSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_inventory_plus-api:bom-detail"
    )
    asset_count = serializers.IntegerField(read_only=True)
...
class PurchaseSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_inventory_plus-api:purchase-detail"
    )
...
class DeliverySerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name="plugins-api:netbox_inventory_plus-api:delivery-detail"
    )
