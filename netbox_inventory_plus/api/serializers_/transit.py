...
from netbox_inventory_plus.models import Courier, Transfer
...
class CourierSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_inventory_plus-api:courier-detail'
    )
    # TODO: Transfer model
...
class TransferSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_inventory_plus-api:transfer-detail'
    )
    # TODO: Asset model
