...
from netbox_inventory_plus.models import Asset, InventoryItemGroup, InventoryItemType
...
class InventoryItemGroupSerializer(NestedGroupModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_inventory_plus-api:inventoryitemgroup-detail'
    )
...
class InventoryItemTypeSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_inventory_plus-api:inventoryitemtype-detail'
    )
...
class AssetSerializer(NetBoxModelSerializer):
    url = serializers.HyperlinkedIdentityField(
        view_name='plugins-api:netbox_inventory_plus-api:asset-detail'
    )
