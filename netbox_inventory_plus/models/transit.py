...
class Courier(NetBoxModel, ContactsMixin):
    ...
    netbox_inventory_plus keeps track of Couriers separate from Suppliers.
    """
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_inventory_plus:courier', args=[self.pk])
...
class Transfer(NetBoxModel):
    ...
    courier = models.ForeignKey(
        ...
        to='netbox_inventory_plus.Courier',
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_inventory_plus:transfer', args=[self.pk])
