...
class InventoryItemGroup(NestedGroupModel):
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_inventory_plus:inventoryitemgroup', args=[self.pk])
...
class InventoryItemType(NetBoxModel, ImageAttachmentsMixin):
    ...
    inventoryitem_group = models.ForeignKey(
        to='netbox_inventory_plus.InventoryItemGroup',
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_inventory_plus:inventoryitemtype', args=[self.pk])
...
class Asset(NetBoxModel, ImageAttachmentsMixin):
    ...
    inventoryitem_type = models.ForeignKey(
        to='netbox_inventory_plus.InventoryItemType',
        on_delete=models.PROTECT,
        related_name='+',
        blank=True,
        null=True,
    ...
    delivery = models.ForeignKey(
        ...
        to='netbox_inventory_plus.Delivery',
        on_delete=models.PROTECT,
        related_name='assets',
        blank=True,
        null=True,
    ...
    transfer = models.ForeignKey(
        ...
        to='netbox_inventory_plus.Transfer',
        on_delete=models.PROTECT,
        related_name='assets',
        blank=True,
        null=True,
    ...
    def get_absolute_url(self):
        return reverse('plugins:netbox_inventory_plus:asset', args=[self.pk])
